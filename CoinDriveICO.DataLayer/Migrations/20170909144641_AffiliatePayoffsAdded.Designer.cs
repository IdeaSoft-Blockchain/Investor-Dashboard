...
namespace CoinDriveICO.DataLayer.Migrations
{
    ...
    [Migration("20170909144641_AffiliatePayoffsAdded")]
    partial class AffiliatePayoffsAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoinDriveICO.DataLayer.Model.AffiliatePayoff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<decimal>("AffiliatePayoffMultiplier");
                    ...
                    b.Property<decimal>("PayoffValue");
            ...
            modelBuilder.Entity("CoinDriveICO.DataLayer.Model.AffiliatePayoff", b =>
                {
                    b.HasOne("CoinDriveICO.DataLayer.Model.AppUser", "AffiliateUser")
                        .WithMany("AssociatedDestinationAffiliatePayoffs")
                        .HasForeignKey("AffiliateUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CoinDriveICO.DataLayer.Model.InnerTransaction", "InnerTransaction")
                        .WithMany("AssociatedAffiliatePayoffs")
                        .HasForeignKey("InnerTransactionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CoinDriveICO.DataLayer.Model.AppUser", "PayingUser")
                        .WithMany("AssociatedSourceAffiliatePayoffs")
